      ...
      <section className="w-full flex flex-row justify-center mx-auto pt-8 mb-16">
        <div className="w-7/12 pl-16">
          ...
          <p className="pt-8 text-center">
            ...
            come home to a clean and comfortable space. That&aposs why we offer a
            wide range of home cleaning services to fit your needs and budget.
            Whether you need weekly, biweekly, or monthly cleaning, or you&aposre
            looking for a one-time deep clean, we have you covered.
          </p>
          <p className="my-4 text-center">
            We understand that your home is more than just a place to live; it&aposs
            a reflection of you and your family. That&aposs why we take the time to
            get to know your needs and preferences before developing a cleaning
            plan that&aposs tailored to your specific home. Our team of experienced
          ...
          <p className="text-center">
            ...
            we&aposre committed to providing our customers with the best possible
            service. We&aposre also proud to be a green company. We use eco-friendly
            cleaning products whenever possible, and we&aposre committed to reducing
          ...
          <ol className="list-disc pl-4 mb-4">
            <li>We&aposre fully licensed and insured.</li>
            <li>We offer a satisfaction guarantee on all of our services.</li>
            <li>We&aposre committed to using eco-friendly cleaning products.</li>
            <li>
              We offer a variety of services to fit your needs and budget.
            </li>
          </ol>
          <p className="text-center">
            If you&aposre looking for a high-quality and reliable home cleaning
